...
$$\text{diabetes}_i=\beta_0+\beta_1\cdot\text{glucose}_i+\beta_2\cdot\text{bmi}_i+\beta_3\cdot\text{pedigree}_i+\beta_4\cdot\text{age}_i+\epsilon_i\ \ \ \text{where}\ \ \ \epsilon_i\stackrel{iid}{\sim}N(\mu,\sigma^2)$$
...
According to the dffits plot, there are no potential influential points. This assumption in met.
...
The most important predictors of diabetes are probably glucose and insulin. I can think of any other variables that would affect the response.
