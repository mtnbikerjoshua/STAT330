...
It turns out that the model fits the data pretty well. An $R^2$ of 87.5% is rather high, and indicates that the variables we chose have done a good job describing the model.
