---
title: "GroupProject1"
authors: "Joshua Carpenter, Mark Guymon, Carter Erickson, Kevin Sanchez"
date: "2/12/2021"
...
After transforming the data, we will check the assumptions of linear regression to see if we can move forward with the analysis.
...
# Box-plot
ggplot(data = premier, mapping = aes(y = residuals)) +
  geom_boxplot() +
  ...
  xlab("")
```
The residuals are roughly normally distributed. The histogram leaves something to be desired, but the boxplot and Q-Q plot look all right. This assumption is met.
