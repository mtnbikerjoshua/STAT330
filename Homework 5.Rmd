...
1. The X’s vs Y are linear:   < your response here: met or not met? >
2. The residuals are normally distributed and centered at zero:   < your response here: met or not met? >
3. The residuals are homoscedastic:   < your response here: met or not met? >
4. The model describes all observations (i.e., there are no influential points):   < your response here: met or not met? >
5. No multicollinearity:   < your response here: met or not met? >
