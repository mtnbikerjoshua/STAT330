...
This assumption is met. There are a few outliers that mess up the plots, but the scatterplots look really good and so do the residuals vs predictors except the outliers.
